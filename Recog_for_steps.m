...
test_img = not(im2bw(imread('D:\Code_github\SIFT_handwritten_digits_recognition\test/6-1.jpg')));
ref_img = not(im2bw(imread('D:\Code_github\SIFT_handwritten_digits_recognition\test/6-2.jpg')));
